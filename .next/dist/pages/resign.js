  ...
  (0, _createClass3.default)(Load, [{
    ...
    value: function render() {
      return _react2.default.createElement(_MuiThemeProvider2.default, null, _react2.default.createElement(_Card.Card, {
        ...
        type: "password",
        fullWidth: true
      }), _react2.default.createElement(_RaisedButton2.default, { label: "\u4E0B\u4E00\u6B65", fullWidth: true, style: { marginTop: 40 } }), _react2.default.createElement("br", null), _react2.default.createElement("br", null), _react2.default.createElement("p", { onClick: this.githubLogin }, _react2.default.createElement("i", { className: "iconfont icon-github", style: { fontSize: 22 } }), "github\u767B\u9646", _react2.default.createElement("a", { href: "javascript:void(0)" }, "\u6CE8\u518C"))));
    }
  }]);
